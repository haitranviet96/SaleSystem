        ...
        <div id="container">
            <header id="header" class="navbar navbar-static-top">
                <div class="navbar-header">
                    ...
                    <a href="http://localhost/sales/admin/index.php?action=orders" class="navbar-brand"><img src="http://localhost/sales/public/admin/image/logo1.png" alt="BK+ Mart" title="BK+ Mart" /></a></div>
                <ul class="nav pull-right">
                 
                    <li><a href="http://localhost/sales/admin/index.php?action=orders"><i class="fa fa-home fa-lg"></i></a>
                    </li>
