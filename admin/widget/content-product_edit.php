    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a href="http://localhost/sales/admin/index.php?action=product" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a>
            </div>
            <h1>Edit Product</h1>
            <ul class="breadcrumb">
                <li><a href="">Home</a></li>
